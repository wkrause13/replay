...
export declare enum AssertedEventType {
...
export declare type PointerDeviceType = 'mouse' | 'pen' | 'touch';
export declare type PointerButtonType = 'primary' | 'auxiliary' | 'secondary' | 'back' | 'forward';
...
export declare type ScrollElementStep = ScrollPageStep & StepWithSelectors;
...
export declare type UserStep = ChangeStep | ClickStep | HoverStep | CloseStep | CustomStep | DoubleClickStep | EmulateNetworkConditionsStep | KeyDownStep | KeyUpStep | NavigateStep | ScrollStep | SetViewportStep;
/**
